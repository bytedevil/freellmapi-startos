<p align="center">
  <img src="icon.svg" alt="FreeLLMAPI Logo" width="21%">
</p>

# FreeLLMAPI on StartOS

> Everything not listed in this document should behave the same as upstream FreeLLMAPI.
